...
'''
Plotting the Obj Function vs Number of Cluesters
'''

plt.figure(figsize=(10, 10))
plt.plot(np.arange(2,16,1), l_kmeans)
plt.title('Obj Function vs Number of Cluesters')
...
'''
Plotting the Obj Function vs Number of Cluesters for cosine sim matrix
'''

plt.figure(figsize=(10, 10))
plt.plot(np.arange(2,16,1), l_cos)
plt.title('Obj Function vs Number of Cluesters for cosine ')
plt.xticks(np.arange(2,16,1))
plt.xlabel('No of Clusters (k)')
plt.ylabel('Objective Function value (J)')
plt.show()
